...
else
{
	...
	<div class="header">
		...
		<div class="inner-header flex">
			...
			xmlns:xlink="http://www.w3.org/1999/xlink"  x="0px" y="0px" viewBox="0 0 185 200" xml:space="preserve">
	...
	<div class="d-block" style="margin-top: 75px; margin-bottom: 75px;">
		<img src="<?= PUBLIC_PATH; ?>/images/Affiche_AQUASPASSAIR_jpg.jpg" alt="affiche ouverture" class="rounded-10 mx-auto d-block">
	</div>
